...
run_hurl_tests ./login.hurl --cookie-jar ./cookie-jar.txt
run_hurl_tests ./clean-db.hurl --cookie ./cookie-jar.txt
run_hurl_tests ./logged-in-redirects.tests.hurl &
run_hurl_tests ./login-page.tests.hurl &
run_hurl_tests ./login.hurl --cookie-jar ./cookie-jar.txt
run_hurl_tests ./create.tests.hurl --cookie ./cookie-jar.txt
run_hurl_tests ./delete.tests.hurl --cookie ./cookie-jar.txt
